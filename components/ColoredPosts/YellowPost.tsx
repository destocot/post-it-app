...
export default function YellowPost({ post }: { post: PostType }) {
  return (
    <Link href={`/posts/${post.id}`}>
      <div className="hover:rotate-1 shadow-lg cursor-pointer m-1 aspect-square bg-yellow-one text-black rounded-sm flex flex-col fold hover:before:border-x-yellow-two">
        <div className="flex bg-yellow-two text-light-one p-2">
