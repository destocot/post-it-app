...
export default function BluePost({ post }: { post: PostType }) {
  return (
    <Link href={`/posts/${post.id}`}>
      <div className="hover:rotate-1 shadow-lg cursor-pointer m-1 aspect-square bg-blue-one text-black rounded-sm flex flex-col fold  hover:before:border-x-blue-two">
        <div className="flex bg-blue-two text-light-one p-2">
