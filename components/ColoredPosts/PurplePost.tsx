...
export default function PurplePost({ post }: { post: PostType }) {
  return (
    <Link href={`/posts/${post.id}`}>
      <div className="hover:rotate-1 shadow-lg cursor-pointer m-1 aspect-square bg-purple-one text-black rounded-sm flex flex-col fold">
        <div className="flex bg-purple-two text-light-one p-2">
